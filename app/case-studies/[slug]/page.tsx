    ...
    if (isMockEnv) {
      const mockStudies = [
        ...
        },
        {
          ...
          architectural_narrative: "<p>Mock Lean4 proofchain narrative.</p>",
        ...
        },
        {
          ...
          classification: "EXPERIMENTAL",
          editorial_content: "A high-performance interactive 2D raytracer written in Rust and compiled to WebAssembly.",
          architectural_narrative: "<p>Mock Rust laser canvas narrative.</p>",
          the_pitch: "A blazing-fast interactive playground.",
          the_reality: "The WebAssembly bridge is a major overhead bottleneck.",
          lessons_learned: "Minimize WASM-JS boundaries at all costs.",
          summary_html: "<div>Rust metrics summary</div>",
          created_at: new Date(),
          updated_at: new Date(),
        }
      ];
