      ...
      const mockStudies = [
        {
          ...
          editorial_content_simplified: "A visual tool for designing database schemas built in TypeScript.",
        ...
        },
        {
          ...
          editorial_content_simplified: "A simplified mapping tool for medical databases.",
