    ...
    if (process.env.CI === "true" || process.env.PLAYWRIGHT_TEST === "true" || !isProduction) {
      ...
      caseStudies = [
        ...
        },
        {
          id: "mock-3",
          slug: "laser-loon",
          title: "Laser Loon: WebAssembly Physics Sandbox",
          primary_language: "Rust",
          github_url: "https://github.com/fderuiter/laser-loon",
          published: true,
          simulated_telemetry: true,
          tags: "Rust, Wasm, Physics",
          classification: "experimental",
          editorial_content: "An experimental chaotic physics sandbox.",
          architectural_narrative: "Mock narrative",
          pitch: "A highly responsive, **WebAssembly-powered** physics sandbox.",
          reality: "Fast-moving loons frequently clipped through barriers.",
          lessons_learned: "Floating-point determinism is extremely hard to enforce.",
          custom_html: `<div class="grid grid-cols-2 gap-2 border border-zinc-800 p-2 text-xs font-mono"><div><strong>Loon Count</strong>: 500</div><div><strong>FPS</strong>: 60</div></div>`,
          created_at: new Date(),
          updated_at: new Date(),
          githubStats: null,
        }
