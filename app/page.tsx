...
export default async function WalkingSkeletonPage() {
  ...
  return (
    <div className="bg-zinc-950 min-h-screen text-foreground overflow-x-hidden flex flex-col">
      ...
      {/* 3. About Section */}
      <section id="about" className="relative py-24 md:py-32 px-6 md:px-12 lg:px-24 flex flex-col items-center border-t border-zinc-900/50 bg-zinc-950 relative overflow-hidden">
        {/* Decorative Blurs */}
