...
export const CommandPalette: React.FC = () => {
  ...
  // Expose programmatic trigger for Playwright test environment to ensure robust E2E test runs
  useEffect(() => {
    if (!mounted) return;
    const win = window as unknown as { __PLAYWRIGHT_TEST__?: boolean; openCommandPalette?: () => void };
    if (typeof window !== "undefined" && win.__PLAYWRIGHT_TEST__) {
      win.openCommandPalette = () => setIsOpen(true);
    }
  }, [mounted, setIsOpen]);
