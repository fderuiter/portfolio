...
export const Hero: React.FC<HeroProps> = ({ className }) => {
  ...
  return (
    <section
      id="hero"
      className={cn(
        "relative min-h-[100dvh] w-full flex flex-col justify-center items-center overflow-hidden bg-zinc-950 px-4 sm:px-6 md:px-8 pt-24 pb-12 sm:py-0",
        className
      )}
    >
      ...
      <div className="relative z-10 w-full max-w-4xl flex flex-col items-center text-center">
        ...
        <motion.div
          ...
          className="mt-8 sm:mt-10 w-full max-w-md sm:max-w-none flex flex-col items-center gap-3 sm:gap-4 sm:flex-row sm:justify-center"
        >
