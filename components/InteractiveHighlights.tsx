...
export const InteractiveHighlights: React.FC = () => {
  ...
  return (
    <div className="w-full mb-6 sm:mb-8 p-5 sm:p-7 bg-[#13151a]/90 border border-white/10 rounded-2xl relative overflow-hidden group hover:border-amber-500/40 transition-colors transition-shadow duration-300 backdrop-blur-md shadow-xl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
        ...
        <Link
          href="/arcade"
          className="w-full sm:w-auto self-start sm:self-center shrink-0 inline-flex items-center justify-center gap-2 px-5 py-3 sm:py-2.5 bg-amber-400 text-black font-mono text-xs font-bold rounded-xl hover:bg-amber-300 transition-colors transition-transform duration-200 shadow-md cursor-pointer active:scale-[0.98]"
        >
