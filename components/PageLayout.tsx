...
export function PageLayout({
  ...
  const variantStyles = {
    standard: "min-h-dvh w-full overflow-x-hidden pt-28 sm:pt-32 pb-16 md:pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col scrollbar-gutter-stable section-isolate",
    studio: "min-h-dvh w-full overflow-x-hidden pt-28 pb-16 px-4 sm:px-6 lg:px-8 flex flex-col flex-1 scrollbar-gutter-stable section-isolate",
    full: "min-h-dvh w-full overflow-x-hidden flex flex-col scrollbar-gutter-stable section-isolate",
  };
