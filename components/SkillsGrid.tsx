...
export const SkillsGrid: React.FC<SkillsGridProps> = ({ languages }) => {
  ...
  return (
    <div ref={containerRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 w-full max-w-4xl mx-auto select-none">
      ...
      <motion.div
        ...
        className="md:col-span-1 lg:col-span-2 p-5 sm:p-6 md:p-8 bg-[#13151a]/80 border border-white/10 rounded-2xl relative overflow-hidden flex flex-col justify-between min-h-[220px] sm:min-h-[250px] hover:border-amber-500/30 transition-all duration-300 backdrop-blur-md shadow-xl"
      >
      ...
      <motion.div
        ...
        onMouseEnter={playSkillHover}
        className="md:col-span-1 lg:col-span-1 p-5 sm:p-6 bg-[#13151a]/80 border border-white/10 rounded-2xl relative overflow-hidden flex flex-col justify-between min-h-[220px] sm:min-h-[250px] hover:border-amber-500/30 transition-all duration-300 backdrop-blur-md shadow-xl"
      >
      ...
      <motion.div
        ...
        className="md:col-span-2 lg:col-span-3 p-5 sm:p-6 md:p-8 bg-[#13151a]/80 border border-white/10 rounded-2xl relative overflow-hidden hover:border-white/20 transition-all duration-300 backdrop-blur-md shadow-xl"
      >
