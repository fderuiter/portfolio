...
export interface UseArcadeEngineReturn<TEngine extends ArcadeEngine<unknown, TSnapshot>, TSnapshot> {
...
export function useArcadeEngine<TEngine extends ArcadeEngine<unknown, TSnapshot>, TSnapshot>(
