...
export const FieldRenderer: React.FC<FieldRendererProps> = ({
  ...
  return (
    <div
      ...
      className={`${spanClass} crf-field-card group relative p-3 sm:p-4 rounded-2xl border transition-all cursor-pointer select-none outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan focus-visible:border-brand-cyan [content-visibility:auto] [contain-intrinsic-size:100px_120px] [contain:layout_style] ${
        isSelected
