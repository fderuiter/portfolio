...
export const FieldRenderer: React.FC<FieldRendererProps> = ({
  ...
  return (
    <div
      ...
      className={`${spanClass} crf-field-card group relative p-3 sm:p-4 rounded-2xl border transition-colors cursor-pointer select-none outline-none focus-visible:ring-2 focus-visible:ring-brand-cyan focus-visible:border-brand-cyan ${
        isSelected
