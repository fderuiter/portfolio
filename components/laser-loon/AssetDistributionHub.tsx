...
const ASSET_ITEMS: AssetFormatItem[] = [
  // Vector Print
  {
    ...
    icon: <IconFileTypeZip className="w-5 h-5 text-amber-400" />,
    category: "vector",
  },
  {
    ...
    icon: <IconFileTypeZip className="w-5 h-5 text-orange-400" />,
    category: "vector",
  },
  {
  ...
  // Raster Edit & Preview
  {
    ...
    icon: <IconFileTypePdf className="w-5 h-5 text-blue-400" />,
    category: "raster",
  },
  {
