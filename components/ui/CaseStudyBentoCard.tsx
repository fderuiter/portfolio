...
const REALITY_CONTENT: Record<string, string> = {
  ...
  sortify: "Achieving 100% air-gapped performance required bundling custom native SQLCipher shared libraries and lightweight ONNX vector models. Under heavy concurrent multi-threaded ingestion, SQLite locks initially blocked the main UI thread, which we resolved by implementing a non-blocking queue architecture and connection pool leasing.",
};
