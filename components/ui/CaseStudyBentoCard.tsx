...
const REALITY_CONTENT: Record<string, string> = {
  ...
  clintrials: "Executing Pyodide WebAssembly in browser Web Workers presented thread-serialization hurdles and cold-start PyPI package hydration delays. Managing zero-latency MCMC dose-escalation state required strict JSON payload marshaling and custom Service Worker caching for Pyodide wheels."
};
