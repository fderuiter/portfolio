...
const REALITY_CONTENT: Record<string, string> = {
  ...
  "four-glory": "Predicting live game outcomes and player props exposed major variance spikes caused by late-breaking rotation scratches and garbage-time stats. Standard K-Fold cross-validation created subtle temporal data leakage, forcing us to rebuild the evaluation engine around strict expanding-window splits and Bayesian shrinkage regularizers."
};
