...
const REALITY_CONTENT: Record<string, string> = {
  ...
  "crf-xl": "Operating inside Office.js WebView sandboxes presented severe restrictions: Web Worker instantiation varies across desktop Excel builds, and context.sync() payload limits choke on large sheet reads. We had to design an asynchronous cell chunking engine and memory-efficient CustomXML part serializer to ensure 100% compliance without freezing Excel."
};
