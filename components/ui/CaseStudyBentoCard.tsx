...
const REALITY_CONTENT: Record<string, string> = {
  ...
  promptops: "Ensuring zero-drift schema compliance across heterogeneous LLM API providers required building a strict 2-pass validation pipeline. Resolving cyclical macro references in Jinja2 templates without runtime latency spikes required dynamic AST parsing and memoized schema compilation."
};
