...
const REALITY_CONTENT: Record<string, string> = {
  ...
  "equipose-randomization": "Enforcing identical bitwise MT19937 seed parity across Python, R, SAS, and Stata required overcoming zero- versus one-indexed array seed mapping differences and floating-point rounding variations across statistical runtimes.",
