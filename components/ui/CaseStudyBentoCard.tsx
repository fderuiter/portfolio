...
const REALITY_CONTENT: Record<string, string> = {
  ...
  "sonos-network-controller": "Navigating heterogenous UPnP device XML schemas across legacy Sonos firmware required extensive namespace fallback handling. Unescaped inner DIDL-Lite metadata blocks initially broke streaming radio parsers, resolved through dedicated XML entity unescaping pipelines and SSDP discovery TTLCache memoization.",
};
