      ...
      {backToHub && (
        <div className="flex justify-center mb-6">
          <Link
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-zinc-900/60 border border-zinc-800 text-xs font-mono text-zinc-400 hover:text-brand-cyan hover:border-brand-cyan/40 transition-colors duration-200 group"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {prev ? (
          <Link
            href={prev.href}
            onMouseEnter={handleHover}
            className="group flex flex-col p-5 rounded-2xl bg-zinc-900/30 border border-zinc-800/80 hover:border-brand-cyan/40 hover:bg-zinc-900/50 transition-colors duration-200"
          >
        ...
        {next ? (
          <Link
            href={next.href}
            onMouseEnter={handleHover}
            className="group flex flex-col items-end text-right p-5 rounded-2xl bg-zinc-900/30 border border-zinc-800/80 hover:border-brand-cyan/40 hover:bg-zinc-900/50 transition-colors duration-200 sm:col-start-2"
          >
            <span className="inline-flex items-center gap-1.5 text-[10px] font-mono uppercase tracking-widest text-zinc-500 group-hover:text-brand-cyan transition-colors mb-1.5">
