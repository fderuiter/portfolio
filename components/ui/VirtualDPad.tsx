...
export const VirtualDPad: React.FC<VirtualDPadProps> = ({
  ...
  return (
    <div
      ...
      className={cn(
        "w-full flex items-center justify-between gap-4 p-4 rounded-2xl bg-zinc-950/60 border border-zinc-800/80 backdrop-blur-xl select-none touch-none",
        className
      )}
    ...
    >
      ...
      <div className="relative w-36 h-36 flex items-center justify-center">
        ...
        <div className="absolute w-12 h-12 rounded-lg bg-zinc-900/60 border border-zinc-800/60 pointer-events-none" />
        ...
        <button
          ...
          className="absolute top-0 left-1/2 -translate-x-1/2 min-w-[44px] min-h-[44px] w-12 h-12 rounded-t-xl bg-zinc-900/80 border-t border-x border-zinc-700/80 active:bg-brand-cyan/20 active:border-brand-cyan active:text-brand-cyan text-zinc-300 flex items-center justify-center transition-all cursor-pointer shadow-md active:scale-95"
        >
        ...
        <button
          ...
          className="absolute bottom-0 left-1/2 -translate-x-1/2 min-w-[44px] min-h-[44px] w-12 h-12 rounded-b-xl bg-zinc-900/80 border-b border-x border-zinc-700/80 active:bg-brand-cyan/20 active:border-brand-cyan active:text-brand-cyan text-zinc-300 flex items-center justify-center transition-all cursor-pointer shadow-md active:scale-95"
        >
        ...
        <button
          ...
          className="absolute left-0 top-1/2 -translate-y-1/2 min-w-[44px] min-h-[44px] w-12 h-12 rounded-l-xl bg-zinc-900/80 border-l border-y border-zinc-700/80 active:bg-brand-cyan/20 active:border-brand-cyan active:text-brand-cyan text-zinc-300 flex items-center justify-center transition-all cursor-pointer shadow-md active:scale-95"
        >
        ...
        <button
          ...
          className="absolute right-0 top-1/2 -translate-y-1/2 min-w-[44px] min-h-[44px] w-12 h-12 rounded-r-xl bg-zinc-900/80 border-r border-y border-zinc-700/80 active:bg-brand-cyan/20 active:border-brand-cyan active:text-brand-cyan text-zinc-300 flex items-center justify-center transition-all cursor-pointer shadow-md active:scale-95"
        >
      ...
      <div className="flex items-center gap-3">
        {onActionBPress && (
          <button
            ...
            className="min-w-[44px] min-h-[44px] w-16 h-16 rounded-2xl bg-zinc-900/80 border border-zinc-700/80 active:bg-purple-500/20 active:border-purple-400 active:text-purple-300 text-zinc-300 flex flex-col items-center justify-center gap-0.5 transition-all cursor-pointer shadow-md active:scale-95"
          >
        ...
        {onActionAPress && (
          <button
            ...
            className="min-w-[44px] min-h-[44px] w-18 h-18 rounded-2xl bg-brand-cyan/15 border-2 border-brand-cyan/60 active:bg-brand-cyan/30 active:border-brand-cyan active:scale-95 text-brand-cyan flex flex-col items-center justify-center gap-0.5 transition-all cursor-pointer shadow-[0_0_20px_rgba(6,182,212,0.15)]"
          >
