...
[fderuiter-portfolio](../../../modules.md) / lib/dx/doctor
...
- [checkLockfileSync](functions/checkLockfileSync.md)
...
- [getBunLockVersion](functions/getBunLockVersion.md)
- [getPackageLockVersion](functions/getPackageLockVersion.md)
