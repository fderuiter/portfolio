...
Defined in: [lib/exceptions.ts:6](https://github.com/fderuiter/portfolio/blob/main/lib/exceptions.ts#L6)
...
> **new GameEngineException**(`message?`): `GameEngineException`

Defined in: [lib/exceptions.ts:7](https://github.com/fderuiter/portfolio/blob/main/lib/exceptions.ts#L7)

#### Parameters

##### message?

`string` = `"Simulated gameplay failure"`
