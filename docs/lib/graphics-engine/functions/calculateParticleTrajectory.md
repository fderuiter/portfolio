...
[fderuiter-portfolio](../../../modules.md) / [lib/graphics-engine](../README.md) / calculateParticleTrajectory

# Function: calculateParticleTrajectory()

> **calculateParticleTrajectory**(`initial`, `velocity`, `gravity`, `time`): [`Point2D`](../type-aliases/Point2D.md)

Defined in: [lib/graphics-engine.ts:399](https://github.com/fderuiter/portfolio/blob/main/lib/graphics-engine.ts#L399)
