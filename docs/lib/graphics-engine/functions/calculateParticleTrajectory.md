...
[temp_dir](../../../modules.md) / [lib/graphics-engine](../README.md) / calculateParticleTrajectory
...
Defined in: [lib/graphics-engine.ts:386](https://github.com/fderuiter/portfolio/blob/main/lib/graphics-engine.ts#L386)
