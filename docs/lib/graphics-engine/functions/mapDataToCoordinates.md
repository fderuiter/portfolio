...
[temp_dir](../../../modules.md) / [lib/graphics-engine](../README.md) / mapDataToCoordinates
...
Defined in: [lib/graphics-engine.ts:216](https://github.com/fderuiter/portfolio/blob/main/lib/graphics-engine.ts#L216)
