...
Defined in: [lib/i18n-dictionary.ts:91](https://github.com/fderuiter/portfolio/blob/main/lib/i18n-dictionary.ts#L91)
...
> **timeline**: `object`[] = `compiledTimelineDetailed`
