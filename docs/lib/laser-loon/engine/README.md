...
[fderuiter-portfolio](../../../modules.md) / lib/laser-loon/engine
...
- [updatePowerUps](functions/updatePowerUps.md)
- [updateShockwaves](functions/updateShockwaves.md)
- [updateTargetsPosition](functions/updateTargetsPosition.md)
