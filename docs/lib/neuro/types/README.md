...
[fderuiter-portfolio](../../../modules.md) / lib/neuro/types
...
- [TerminalLog](interfaces/TerminalLog.md)
- [TissueSegmentLabels](interfaces/TissueSegmentLabels.md)
- [VolumeDimensions](interfaces/VolumeDimensions.md)
- [VoxelCoord](interfaces/VoxelCoord.md)
- [VoxelEdit](interfaces/VoxelEdit.md)
