...
[fderuiter-portfolio](../../modules.md) / lib/pretext-block-parser

# lib/pretext-block-parser
...
- [StructuredBlockType](type-aliases/StructuredBlockType.md)

## Variables

- [BLOCK\_LAYOUT\_CONFIG](variables/BLOCK_LAYOUT_CONFIG.md)
