...
[fderuiter-portfolio](../../../../modules.md) / [lib/site-governance/doa-engine](../README.md) / computeAuditHash
...
`Omit`\<[`Part11AuditEntry`](../../types/interfaces/Part11AuditEntry.md), `"hash"`\>
