...
Defined in: [lib/working-with-duck-engine.ts:2750](https://github.com/fderuiter/portfolio/blob/main/lib/working-with-duck-engine.ts#L2750)
...
Defined in: [lib/working-with-duck-engine.ts:2798](https://github.com/fderuiter/portfolio/blob/main/lib/working-with-duck-engine.ts#L2798)
...
Defined in: [lib/working-with-duck-engine.ts:2762](https://github.com/fderuiter/portfolio/blob/main/lib/working-with-duck-engine.ts#L2762)
...
Defined in: [lib/working-with-duck-engine.ts:2786](https://github.com/fderuiter/portfolio/blob/main/lib/working-with-duck-engine.ts#L2786)
