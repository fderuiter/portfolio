...
[fderuiter-portfolio](../../../modules.md) / lib/crf/types

# lib/crf/types

## Interfaces

- [AstCondition](interfaces/AstCondition.md)
- [AuditTrailEntry](interfaces/AuditTrailEntry.md)
- [BiomedicalConcept](interfaces/BiomedicalConcept.md)
- [BiomedicalConceptProperty](interfaces/BiomedicalConceptProperty.md)
- [CdashVariableMetadata](interfaces/CdashVariableMetadata.md)
...
- [StudyReviewActor](interfaces/StudyReviewActor.md)
- [StudyReviewEventBase](interfaces/StudyReviewEventBase.md)
- [StudyReviewTarget](interfaces/StudyReviewTarget.md)
- [StudyReviewThread](interfaces/StudyReviewThread.md)
...
- [StudyReviewEvent](type-aliases/StudyReviewEvent.md)
- [StudyReviewRole](type-aliases/StudyReviewRole.md)
