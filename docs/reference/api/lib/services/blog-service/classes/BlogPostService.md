...
> `static` **submitReaction**(`input`, `connectionHash`): `Promise`\<\{ `counts?`: `Record`\<`string`, `number`\>; `message?`: `string`; `notFound?`: `boolean`; `reactionType?`: `string`; `success`: `boolean`; `userReactions?`: `string`[]; \}\>
...
`Promise`\<\{ `counts?`: `Record`\<`string`, `number`\>; `message?`: `string`; `notFound?`: `boolean`; `reactionType?`: `string`; `success`: `boolean`; `userReactions?`: `string`[]; \}\>
