...
[fderuiter-portfolio](../../../../modules.md) / lib/trial-and-error/internal/table

# lib/trial-and-error/internal/table
...
- [KM\_REDLINE\_PENALTY](variables/KM_REDLINE_PENALTY.md)
- [KM\_SYNERGY](variables/KM_SYNERGY.md)
- [PROVENANCE\_ALERT](variables/PROVENANCE_ALERT.md)
- [RELIC\_RACK\_FULL](variables/RELIC_RACK_FULL.md)
- [RELIC\_SLOTS](variables/RELIC_SLOTS.md)
