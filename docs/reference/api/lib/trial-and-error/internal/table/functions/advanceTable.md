...
[fderuiter-portfolio](../../../../../modules.md) / [lib/trial-and-error/internal/table](../README.md) / advanceTable

# Function: advanceTable()

> **advanceTable**(`scenario`, `state`, `action`): [`TableState`](../interfaces/TableState.md)
