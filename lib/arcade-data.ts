...
export const ARCADE_GAMES_METADATA: ArcadeGameMetadata[] = [
  ...
  },
  {
    ...
    description:
      "Circular 280×280 Monkey C Mayhem smartwatch simulator running the Garmin Schvitz App artifact under strict 32KB RAM constraints.",
    mechanics: [
