...
export const FREE_TIER_BUDGET_LEDGER: ProviderLedgerEntry[] = [
  {
    ...
    status: "critical",
    notes:
      "Critical capacity constraint (96% used, 0.4 GB headroom); see issue #691/#692 for candidate review",
  },
  {
    provider: "Vercel",
    ...
    resetWindow: "Rolling 30-day window",
    status: "healthy",
    notes: "Healthy headroom (4.15 GB / 41.5% remaining)",
  },
  {
    provider: "Vercel",
    resource: "Build Time",
    ...
    status: "warning",
    notes:
      "Warning threshold exceeded (86% used, 14 hours remaining); monitor dev/preview build volume",
  },
  {
    provider: "Vercel",
